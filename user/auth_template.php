...
<div class="container form-container">
    ...
    <form action="/actions/auth_user.php" method="POST">
        ...
        <div class="mb-3">
            <label for="username" class="form-label text-white">Имя пользователя или электронная почта</label>
        ...
        <button type="submit" class="btn btn-color text-white w-100">Авторизация</button>
    </form>
</div>
<style>
    /* Фон для страницы */
